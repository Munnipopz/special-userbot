...
USER_BOT_NO_WARN = ("`Hello, This is FaltuUserBotA 🥀You have found your way here to my master,`"
                   f"{DEFAULTUSER}'s `inbox. Time to show up ..\n"
                    "Leave your Name,Reason Get people in the room to say “yes” Have them agree to something (even unrelated) right off the bat. ..`⭕️\n\n"
